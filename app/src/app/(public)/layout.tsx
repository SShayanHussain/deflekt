    ...
    <div className="min-h-screen flex flex-col bg-background selection:bg-primary/20">
      ...
      <footer className="border-t py-12 bg-muted/20">
        <div className="container mx-auto max-w-7xl px-4 md:px-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex items-center gap-2">
            <div className="w-6 h-6 rounded-md bg-gradient-to-br from-primary to-accent flex items-center justify-center text-primary-foreground opacity-50 grayscale">
            ...
            <span className="font-semibold text-muted-foreground">Deflekt</span>
          </div>
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} Deflekt. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
